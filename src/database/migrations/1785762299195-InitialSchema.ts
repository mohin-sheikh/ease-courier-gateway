...
export class InitialSchema1785762299195 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."orders_courierpartner_enum" AS ENUM('URBANEBOLT', 'MOCK')`);
        await queryRunner.query(`CREATE TYPE "public"."orders_status_enum" AS ENUM('PENDING', 'QUEUED', 'PROCESSING', 'CREATED', 'PICKED_UP', 'IN_TRANSIT', 'OUT_FOR_DELIVERY', 'DELIVERED', 'CANCELLED', 'FAILED')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_b8fa439d0be6ec87d9820af83e" ON "orders" ("courierTrackingNumber") `);
        await queryRunner.query(`CREATE INDEX "IDX_c9b95b5d139280f39a9176f0ec" ON "orders" ("courierPartner") `);
        await queryRunner.query(`CREATE INDEX "IDX_775c9f06fc27ae3ff8fb26f2c4" ON "orders" ("status") `);
        await queryRunner.query(`CREATE TYPE "public"."audit_logs_action_enum" AS ENUM('ORDER_CREATED', 'ORDER_CANCELLED', 'TRACKING_SYNC', 'TOKEN_REFRESH', 'RETRY', 'QUEUE_PROCESSED')`);
        await queryRunner.query(`CREATE TYPE "public"."audit_logs_courier_enum" AS ENUM('URBANEBOLT', 'MOCK')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."batches_status_enum" AS ENUM('PENDING', 'PROCESSING', 'PARTIAL_SUCCESS', 'COMPLETED', 'FAILED')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."tracking_history_status_enum" AS ENUM('PENDING', 'QUEUED', 'PROCESSING', 'CREATED', 'PICKED_UP', 'IN_TRANSIT', 'OUT_FOR_DELIVERY', 'DELIVERED', 'CANCELLED', 'FAILED')`);
        await queryRunner.query(`CREATE TABLE "tracking_history" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "status" "public"."tracking_history_status_enum" NOT NULL, "location" character varying(255), "remarks" text, "courierTimestamp" TIMESTAMP WITH TIME ZONE, "rawPayload" jsonb, "order_id" uuid NOT NULL, CONSTRAINT "PK_5e58aa7bd8c7a6342010afd445a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_ad8d9f8806478557d71b8886cd" ON "tracking_history" ("status") `);
        await queryRunner.query(`CREATE INDEX "IDX_cdf979f51f6720c6e85a4998ce" ON "tracking_history" ("order_id") `);
        await queryRunner.query(`ALTER TABLE "audit_logs" ADD CONSTRAINT "FK_c38be52b1a471cd556e1bcda243" FOREIGN KEY ("order_id") REFERENCES "orders"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "batch_items" ADD CONSTRAINT "FK_4052dad1531c1027609d0f1f06c" FOREIGN KEY ("batch_id") REFERENCES "batches"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "batch_items" ADD CONSTRAINT "FK_d19ba1d9a395df3557caff56dc5" FOREIGN KEY ("order_id") REFERENCES "orders"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tracking_history" ADD CONSTRAINT "FK_cdf979f51f6720c6e85a4998ce7" FOREIGN KEY ("order_id") REFERENCES "orders"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "tracking_history" DROP CONSTRAINT "FK_cdf979f51f6720c6e85a4998ce7"`);
        ...
        await queryRunner.query(`ALTER TABLE "audit_logs" DROP CONSTRAINT "FK_c38be52b1a471cd556e1bcda243"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_cdf979f51f6720c6e85a4998ce"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_ad8d9f8806478557d71b8886cd"`);
        await queryRunner.query(`DROP TABLE "tracking_history"`);
        await queryRunner.query(`DROP TYPE "public"."tracking_history_status_enum"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."batch_items_processingstatus_enum"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_c9b95b5d139280f39a9176f0ec"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b8fa439d0be6ec87d9820af83e"`);
